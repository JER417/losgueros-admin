...
export default function NuevoPedidoPage() {
  ...
  // Al seleccionar producto del catálogo, pre-llena concepto y precio
      ...
      <form onSubmit={handleSubmit}>
          ...
          {selectedCliente && (
            <div
              className={`mt-4 rounded-lg border p-3 text-sm ${
                hasAddress ? "border-amber-200 bg-amber-50" : "border-red-200 bg-red-50"
              }`}
            >
                  ...
                  {hasAddress ? (
                    <>
                      ...
                      <p className="mt-0.5 text-slate-600">
                        {dir!.calle} {dir!.noExt}
                        {dir!.noInt ? ` Int. ${dir!.noInt}` : ""}, Col. {dir!.colonia}, {dir!.ciudad}
                      </p>
                      {dir!.referencias && (
        ...
        <div className="mb-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mb-2 hidden grid-cols-12 gap-2 text-xs font-medium uppercase tracking-wide text-slate-500 md:grid">
            ...
            <div className="col-span-3">Del catálogo</div>
              ...
              <div key={item.id} className="grid grid-cols-12 items-center gap-2">
                ...
                <div className="col-span-2">
                  <input
                    ...
                    value={item.cantidad}
                    onChange={(e) =>
                      handleItemChange(item.id, "cantidad", parseInt(e.target.value) || 1)
                    }
                ...
                <div className="col-span-1 flex justify-center">
                  <button
                    type="button"
                    onClick={() => {
                      if (items.length > 1) setItems((p) => p.filter((i) => i.id !== item.id));
                    }}
